...
The current development version can be found here: https://latest.dukecon.org/javaland/2017/[JavaLand 2017], https://latest.dukecon.org/javaland/2018/[JavaLand 2018], https://latest.dukecon.org/doag/2017/[DOAG 2017] and
...
* analyze if etag (If-Match) works correctly or add it
